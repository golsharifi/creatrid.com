const es = {
  ...
  vault: {
    ...
    noContent: "Sin contenido aun. Sube tu primera pieza de contenido.",
    allTypes: "Todos",
    images: "Imagenes",
    video: "Video",
    audio: "Audio",
    ...
    uploadSubtitle: "Sube archivos a tu Boveda de Contenido. Soportado: imagenes, video, audio, texto y mas.",
    dropzone: "Arrastra y suelta un archivo aqui, o haz clic para explorar",
    dropzoneActive: "Suelta el archivo aqui...",
    maxSize: "Tamano maximo: 500 MB",
    titleLabel: "Titulo",
    ...
    uploading: "Subiendo...",
    upload: "Subir",
    proofTitle: "Prueba de Propiedad",
    sha256: "Hash SHA-256",
    createdOn: "Creado el",
    download: "Descargar",
    edit: "Editar",
    deleteContent: "Eliminar Contenido",
    confirmDelete: "Estas seguro de que quieres eliminar este contenido? Esta accion no se puede deshacer.",
    fileSize: "Tamano del archivo",
    contentType: "Tipo",
    licensesTitle: "Ofertas de Licencia",
    addLicense: "Agregar Licencia",
    noLicenses: "Sin ofertas de licencia aun. Agrega una para vender este contenido.",
  ...
  marketplace: {
    ...
    licensePurchased: "Licencia comprada exitosamente!",
    checkoutCanceled: "El pago fue cancelado. No se realizaron cambios.",
